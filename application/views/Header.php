    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?php if ($Halaman == "Validasi Dosen") { echo "menu-open"; } ?>">
                  <a href="#" class="nav-link <?php if ($Halaman == "Validasi Dosen") { echo "active"; } ?>">
                ...
                <li class="nav-item has-treeview <?php if ($Halaman == "Info Dosen") { echo "menu-open"; } ?>">
                  <a href="#" class="nav-link <?php if ($Halaman == "Info Dosen") { echo "active"; } ?>">
                  <i class="nav-icon fas fa-tasks"></i>
                  <p>
                  <b>Info Validasi</b>
                    <i class="right fas fa-angle-left"></i>
                  ...
                  <?php
                    $JenisKegiatan = array("InfoBimbingan","InfoUjianProposal","InfoUjianSkripsi");
                    $NamaKegiatan = array("Pembimbing","Ujian Proposal","Ujian Skripsi");
                    $Icon = array("users","users","users");
                  ?>
                  <?php for ($i=0; $i < count($JenisKegiatan); $i++) {?>
