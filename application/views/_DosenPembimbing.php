<div class="content-wrapper">
                            ...
                            <?php $No = 1; foreach ($DosenPembimbing as $key) { ?>
                              <tr>	
                                ...
                                <td class="text-center align-middle">
                                  <button CekData="<?=$key['NIM']."|".$key['Nama']."|".$key['Gender']."|".$key['Alamat']."|".$key['HP']."|".$key['Konsentrasi']."|".$key['JudulProposal']."|".$key['DosenPembimbing']?>" class="btn btn-sm btn-warning CekData"><i class="fas fa-edit"></i></button>
    ...
    <script src="<?=base_url('bootstrap/js/Borang.js')?>"></script>
        ...
        $(document).on("click",".CekData",function(){
          ...
          if (Pisah[7] != "") {
            $("#DosenPembimbing").val(Pisah[7].split("$")[0])
          }
        ...
        $("#ValidasiProposal").click(function() {
          var Mhs = { NIM: $("#NIM").val(),
                      DosenPembimbing: $("#DosenPembimbing").val()+'$'+$("#DosenPembimbing option:selected").text(),
        ...
        $("#TolakProposal").click(function() {
          var Mhs = { NIM: $("#NIM").val(),
                      StatusProposal: 'Ditolak Oleh Korprodi Karena '+ $("#Penolakan").val()}
