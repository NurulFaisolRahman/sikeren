<?php
  ...
  header('Content-Disposition: attachment; filename=RekapDosenPembimbing.xls');
?>
  ...
  <!--[if gte mso 9]>
   <xml>
    <o:DocumentProperties>
     ...
     <o:Created>2022-05-26T23:49:59</o:Created>
     <o:LastAuthor>WINDOWS 10</o:LastAuthor>
     <o:LastSaved>2022-05-26T23:59:00</o:LastSaved>
    </o:DocumentProperties>
    <o:CustomDocumentProperties>
     <o:ICV dt:dt="string">0B6FD40C7880422D96EEC5288F0822B1</o:ICV>
     <o:KSOProductBuildVer dt:dt="string">1033-11.2.0.11130</o:KSOProductBuildVer>
    </o:CustomDocumentProperties>
   </xml>
  <![endif]-->
  <style>
...
.xl69
 ...
 -->  </style>
  <!--[if gte mso 9]>
   <xml>
    ...
    <x:SupBook>
     <x:Path>C:\Users\Faisol\Videos\</x:Path>
    </x:SupBook>
   </xml>
  <![endif]-->
 </head>
 <body link="blue" vlink="purple">
  <table width="1313" border="0" cellpadding="0" cellspacing="0" style='width:984.75pt;border-collapse:collapse;table-layout:fixed;'>
   <col width="12" style='mso-width-source:userset;mso-width-alt:438;'/>
   ...
   <col width="96" style='mso-width-source:userset;mso-width-alt:3510;'/>
   <col width="250" style='mso-width-source:userset;mso-width-alt:9142;'/>
   <col width="485" style='mso-width-source:userset;mso-width-alt:17736;'/>
   <tr height="20" style='height:15.00pt;'>
    <td height="20" width="12" style='height:15.00pt;width:9.00pt;'></td>
    <td width="40" style='width:30.00pt;'></td>
    <td width="145" style='width:108.75pt;'></td>
    <td width="285" style='width:213.75pt;'></td>
    <td width="96" style='width:72.00pt;'></td>
    <td width="250" style='width:187.50pt;'></td>
    <td width="485" style='width:363.75pt;'></td>
   </tr>
   <tr height="20" style='height:15.00pt;'>
    <td height="20" style='height:15.00pt;'></td>
    <td class="xl65" x:str>No</td>
    <td class="xl66" x:str>NIP</td>
    <td class="xl66" x:str>Dosen</td>
    <td class="xl66" x:str>NIM</td>
    <td class="xl66" x:str>Mahasiswa</td>
    <td class="xl66" x:str>Judul</td>
   </tr>
   <?php $No = 1; foreach ($Mhs as $key) { ?>
    <tr height="20" style='height:15.00pt;'>
      <td height="20" style='height:15.00pt;'></td>
      <td class="xl67" x:num><?=$No++?></td>
      <td class="xl69" x:str><?=$key['NIPPembimbing']?></td>
      <td class="xl69" x:str><?=$key['NamaPembimbing']?></td>
      <td class="xl69" x:str><?=$key['NIM']?></td>
      <td class="xl69" x:str><?=$key['Nama']?></td>
      <td class="xl69" x:str><?=$key['JudulProposal']?></td>
    </tr>  
   <?php } ?>
   <![if supportMisalignedColumns]>
    <tr width="0" style='display:none;'>
     <td width="12" style='width:9;'></td>
     <td width="40" style='width:30;'></td>
     <td width="145" style='width:109;'></td>
     <td width="285" style='width:214;'></td>
     <td width="96" style='width:72;'></td>
     <td width="250" style='width:188;'></td>
     <td width="485" style='width:364;'></td>
    </tr>
   <![endif]>
  </table>
 </body>
