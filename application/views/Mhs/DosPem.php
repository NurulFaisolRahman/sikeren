													...
													<?php if ($Mhs['DraftProposal'] != "") { ?>
														<tr>
															...
															<td style="text-align: center;">
																<button Edit="<?=$Mhs['NIM']."|".$Mhs['Nama']."|".$Mhs['Gender']."|".$Mhs['Alamat']."|".$Mhs['HP']."|".$Mhs['Konsentrasi']."|".$Mhs['JudulProposal']."|".$Mhs['DraftProposal']."|".$Mhs['KRS']."|".$Mhs['Transkrip']?>" class="btn btn-sm btn-warning border-light Edit"><i class="fa fa-edit"></i></button>
																...
																<button LihatKRS="<?=base_url('Proposal/'.$Mhs['KRS'])?>" class="btn btn-sm btn-primary border-light LihatKRS"><i class="fa fa-file-pdf-o"></i></button>  
															...
															<td style="vertical-align: middle;">
																<?php if ($Mhs['StatusProposal'] == 'Disetujui Pembimbing') { echo explode("$",$Mhs['DosenPembimbing'])[1]; }?>
															</td>
														</tr>
													<?php } ?>
												</tbody>
										...
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-lg-12">
													<div class="input-group input-group-sm">
														<div class="input-group-prepend">
															<span class="input-group-text bg-primary text-light"><b>Transkrip Nilai</b></span>
														</div>
									...
									<div class="card-body border border-primary bg-warning">
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-lg-12">
													<button type="button" class="btn btn-sm btn-primary" id="EditProposal"><b>SIMPAN&nbsp;<div id="LoadingEdit" class="spinner-border spinner-border-sm text-white" role="status" style="display: none;"></div></b></button>
          ...
          $('#ModalBimbingan').modal("show")
				...
				$("#InputBimbingan").click(function() {
					if ($("#PoinBimbingan").val() === "") {
						...
						var fd = new FormData()						
						fd.append('DosenPembimbing','<?=explode("$",$Mhs['DosenPembimbing'])[0]?>')
