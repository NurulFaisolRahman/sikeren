<div class="content-wrapper">
                            ...
                            <?php $No = 1; foreach ($DosenPembimbing as $key) { ?>
                              <tr>	
                                ...
                                <td class="text-center align-middle">
                                  ...
                                  <button LihatKRS="<?=base_url('Proposal/'.$key['KRS'])?>" class="btn btn-sm btn-primary LihatKRS"><i class="fas fa-file-pdf"></i></button>  
    ...
    <script src="<?=base_url('bootstrap/js/Borang.js')?>"></script>
        ...
        $("#ValidasiProposal").click(function() {
          var Mhs = { NIM: $("#NIM").val(),
                      StatusProposal: 'Menunggu Persetujuan Korprodi' }
